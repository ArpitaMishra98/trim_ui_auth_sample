...
export const MuiThemeOptions = (mode: PaletteMode): ThemeOptions => {
  return {
    ...
    typography: {
      fontFamily: ["roslindaletext_regular"].join(","),
      fontSize: 15,
      h1: {
        fontSize: "67px",
        lineHeight: "1.2",
        fontWeight: "normal",
        fontFamily: "roslindaledeckNarSBd",
          ...
          root: ({ ownerState }) => {
            if (
              ...
              return {
                ...
                background: `${primaryColors?.color03202E} !important`,
            ...
            if (
              ...
              return {
                ...
                "&:hover": {
                  background: `${primaryColors?.color03202E} !important`,
                  borderColor: primaryColors?.color03202E,
