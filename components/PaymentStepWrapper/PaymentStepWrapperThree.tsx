...
function PaymentStepWrapperThree({ stepperButton }: any) {
  ...
  return (
    <StepFormWrappersStyled>
      <Box className="consult_wrap_gap shape_backs">
        <Box className="shape_backs_imgs after_paystep3" />
              ...
              <Box className="head_center_tps">
                <Typography variant="h2" className="cmn_head">
                  <Typography variant="caption">
                    Are you currently taking any prescription-only medicines,{" "}
                  </Typography>{" "}
                  over the counter medicines, alternative medicines or
                  recreational drugs?*
                </Typography>
              </Box>
...
export default PaymentStepWrapperThree;
