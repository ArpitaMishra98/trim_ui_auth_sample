...
function PaymentStepWrapperEight({ stepperButton }: any) {
  ...
  return (
    <StepFormWrappersStyled>
      <Box className="consult_wrap_gap shape_backs">
        <Box className="shape_backs_imgs after_paystep8" />
              ...
              <Box className="head_center_tps">
                <Typography variant="h2" className="cmn_head">
                  <Typography variant="caption">
                    Do you have any history of kidney,
                  </Typography>{" "}
...
export default PaymentStepWrapperEight;
