...
function PaymentStepWrapperSix({ stepperButton }: any) {
  ...
  return (
    <StepFormWrappersStyled>
      <Box className="consult_wrap_gap shape_backs">
        <Box className="shape_backs_imgs after_paystep6" />
            ...
            <Box className="brthplace_whr">
              <Box className="head_center_tps">
                <Typography variant="h2" className="cmn_head">
                  <Typography variant="caption">Do you have</Typography> any
                  known allergies?*
                </Typography>
              </Box>
...
export default PaymentStepWrapperSix;
