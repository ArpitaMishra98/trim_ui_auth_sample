...
function PaymentStepWrapperSeven({ stepperButton }: any) {
  return (
    <StepFormWrappersStyled>
      <Box className="consult_wrap_gap shape_backs">
        <Box className="shape_backs_imgs after_paystep7" />
            ...
            <Box className="hetmsrd_wraps paystepStepFour">
              <Box className="head_center_tps">
                <Typography variant="h2" className="cmn_head">
                  <Typography variant="caption"> Please provide</Typography>{" "}
                  more details*
                </Typography>
              </Box>
...
export default PaymentStepWrapperSeven;
