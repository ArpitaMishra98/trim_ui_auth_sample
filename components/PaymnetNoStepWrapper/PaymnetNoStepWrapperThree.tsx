...
function PaymnetNoStepWrapperThree({ stepperButton }: any) {
              ...
              <Box className="head_center_tps">
                <Typography variant="h2" className="cmn_head">
                  <Typography variant="caption">
                    Do you or any family members have a history of thyroid
                    cancer, specifically medullary thyroid carcinoma (MTC), or a
                    condition known as
                  </Typography>{" "}
...
export default PaymnetNoStepWrapperThree;
