...
export default function Login({ stepWelcome, UpdateStepWelcome }: any) {
    ...
    <>
      <Box className="lets_start_nameGrid">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            <Grid item md={12} xs={12} className="lets_start_nameGrid_col">
              <InputFieldCommon placeholder="Email" {...register("email")} />
